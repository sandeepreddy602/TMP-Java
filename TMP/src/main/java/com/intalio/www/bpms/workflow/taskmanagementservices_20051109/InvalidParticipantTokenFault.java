...
/**
 * InvalidParticipantTokenFault.java
 *
 ...
 */
            ...
            /**
            *  InvalidParticipantTokenFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InvalidParticipantTokenFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/",
                "invalidParticipantTokenFault",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":invalidParticipantTokenFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "invalidParticipantTokenFault",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/";
                                    writeStartElement(null, namespace, "invalidToken", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static InvalidParticipantTokenFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InvalidParticipantTokenFault object =
                new InvalidParticipantTokenFault();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"invalidParticipantTokenFault".equals(type)){
                                ...
                                return (InvalidParticipantTokenFault)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
