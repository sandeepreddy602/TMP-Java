 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static FailRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FailRequest object =
                new FailRequest();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"failRequest".equals(type)){
                                ...
                                return (FailRequest)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
