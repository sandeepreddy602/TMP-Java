...
/**
 * UnavailableAttachmentFault.java
 *
 ...
 */
            ...
            /**
            *  UnavailableAttachmentFault bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UnavailableAttachmentFault
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/",
                "unavailableAttachmentFault",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":unavailableAttachmentFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "unavailableAttachmentFault",
    ...
    public static class Factory{
        ...
        */
        public static UnavailableAttachmentFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UnavailableAttachmentFault object =
                new UnavailableAttachmentFault();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"unavailableAttachmentFault".equals(type)){
                                ...
                                return (UnavailableAttachmentFault)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
