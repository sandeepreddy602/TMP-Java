                ...
                "ns1");
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localUnavailableTaskIdTracker = false ;

                           public boolean isUnavailableTaskIdSpecified(){
                               return localUnavailableTaskIdTracker;
                           }
                           ...
                           public  java.lang.String[] getUnavailableTaskId(){
                             ...
                             */
                             public void addUnavailableTaskId(java.lang.String param){
                                ...
                                localUnavailableTaskIdTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localUnavailableTaskId);
                               list.add(param);
                               this.localUnavailableTaskId =
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":unavailableTaskFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "unavailableTaskFault",
                ...
                if (localReasonTracker){
                             ...
                             } if (localUnavailableTaskIdTracker){
                             if (localUnavailableTaskId!=null) {
                                   namespace = "http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/";
                                   for (int i = 0;i < localUnavailableTaskId.length;i++){
                                            ...
                                            if (localUnavailableTaskId[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "unavailableTaskId", xmlWriter);
                                  ...
                                  for (int i = 0;i < localUnavailableTaskId.length;i++){
                                         ...
                                         if (localUnavailableTaskId[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/",
                                                                              "unavailableTaskId"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUnavailableTaskId[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static UnavailableTaskFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UnavailableTaskFault object =
                new UnavailableTaskFault();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"unavailableTaskFault".equals(type)){
                                ...
                                return (UnavailableTaskFault)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list2.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setUnavailableTaskId((java.lang.String[])
