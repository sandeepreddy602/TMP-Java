 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":invalidInputMessageFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "invalidInputMessageFault",
    ...
    public static class Factory{
        ...
        */
        public static InvalidInputMessageFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InvalidInputMessageFault object =
                new InvalidInputMessageFault();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"invalidInputMessageFault".equals(type)){
                                ...
                                return (InvalidInputMessageFault)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
