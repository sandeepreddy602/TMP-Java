...
/**
 * TaskOwnerAndStateMetadata.java
 *
 ...
 */
            ...
            /**
            *  TaskOwnerAndStateMetadata bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TaskOwnerAndStateMetadata
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = taskOwnerAndStateMetadata
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":taskOwnerAndStateMetadata",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "taskOwnerAndStateMetadata",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static TaskOwnerAndStateMetadata parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TaskOwnerAndStateMetadata object =
                new TaskOwnerAndStateMetadata();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"taskOwnerAndStateMetadata".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TaskOwnerAndStateMetadata)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
