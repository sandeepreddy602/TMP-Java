 ...
 */
            ...
            /**
            *  RemoveAttachmentRequest bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeAttachmentRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeAttachmentRequest",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/";
                                    writeStartElement(null, namespace, "attachmentUrl", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static RemoveAttachmentRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveAttachmentRequest object =
                new RemoveAttachmentRequest();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeAttachmentRequest".equals(type)){
                                ...
                                return (RemoveAttachmentRequest)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
