 ...
 */
            ...
            /**
            *  DeletePipaRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeletePipaRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deletePipaRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deletePipaRequest",
                           xmlWriter);
                                    ...
                                    writeStartElement(null, namespace, "pipaurl", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static DeletePipaRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeletePipaRequest object =
                new DeletePipaRequest();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deletePipaRequest".equals(type)){
                                ...
                                return (DeletePipaRequest)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
