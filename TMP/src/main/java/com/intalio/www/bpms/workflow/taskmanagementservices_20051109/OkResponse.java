 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static OkResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OkResponse object =
                new OkResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"okResponse".equals(type)){
                                ...
                                return (OkResponse)com.intalio.www.bpms.workflow.taskmanagementservices_20051109.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
